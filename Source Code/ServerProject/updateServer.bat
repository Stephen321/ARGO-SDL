...
pscp -i "G:\ArgoTeamD.ppk" *.cpp ubuntu@34.250.8.240:/home/ubuntu/socketServer 
pscp -i "G:\ArgoTeamD.ppk" *.h ubuntu@34.250.8.240:/home/ubuntu/socketServer 
plink -i "G:\ArgoTeamD.ppk" ubuntu@34.250.8.240 "cd socketServer/; ./build.sh"
